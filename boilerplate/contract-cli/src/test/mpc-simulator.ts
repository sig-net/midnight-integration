// Local MPC simulator: read a request from the ledger, build + sign + broadcast the EVM tx,
// then Schnorr-sign (requestId, hash(outputData)) over the observed result.
...
// Private-key counterpart of deriveEvmAddress: rootPriv + keccak256(epsilon) (mod n).
