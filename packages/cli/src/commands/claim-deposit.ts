 ...
 *
 * Wired behavior: fetch the MPC's respond-bidirectional attestation
 * (`serializedOutput` + Schnorr signature components) for `requestId` from
 * the signet contract, then
