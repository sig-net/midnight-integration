...
/** Compact's secp256k1 base field. */
export const SECP256K1_BASE = { kind: "secp256k1-base" } as const satisfies CompactType;

/** Compact's secp256k1 scalar field. */
export const SECP256K1_SCALAR = { kind: "secp256k1-scalar" } as const satisfies CompactType;
