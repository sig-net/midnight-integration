...
| ------- | ------ | ------ |
| `@sig-net/*` npm packages | 0.21.0-rc.1 | [`packages/*/package.json`](packages) |
| fakenet MPC responder | `ghcr.io/sig-net/fakenet:0.17.0` | [`docker-compose.yaml`](docker-compose.yaml) |
