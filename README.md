...
| ------- | ------ | ------ |
| `@sig-net/*` npm packages | 0.22.0 | [`packages/*/package.json`](packages) |
| fakenet MPC responder | `ghcr.io/sig-net/fakenet:0.24.0` | [`docker-compose.yaml`](docker-compose.yaml) |
